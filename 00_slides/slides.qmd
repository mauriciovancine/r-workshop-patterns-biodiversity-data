...
1. Basics of tools for **downloading and cleaning** species occurrence data
...
# There is a small problem: we do not know biodiversity...
...
![](img/spatial_analysis_grids.png){.absolute width=580 height=350 right=-50 top=320}
...
![](img/spatial_analysis_hex.png){.absolute width=580 height=350 right=-50 top=320}
...
**Point density (kernel or heat maps)**
...
<center>
<img src="img/sdm_metodos_glm.png" style="width:55%"/>
</center>
...
![](img/sn01.png){.absolute width=600 height=300 right=-100 top=350}
...
- Fragment **prioritization** based on species composition and landscape metrics
:::

![](img/sn02_01.png){.absolute width=400 height=400 right=600 top=300}
![](img/sn02_02.jpeg){.absolute width=400 height=400 right=100 top=300}
...
- It lives in open and semi-open habitats
:::
